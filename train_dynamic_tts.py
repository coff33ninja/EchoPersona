...
def train_tts_model(model_name, dataset_path, output_path, use_phonemes=True, phoneme_language="en-us", multi_speaker=False):
    ...
    meta_file_train = os.path.abspath(os.path.join(dataset_path, "metadata.csv"))
    meta_file_val = os.path.abspath(os.path.join(dataset_path, "valid.csv"))
    ...
    dataset_config = BaseDatasetConfig(
        ...
        path=os.path.abspath(os.path.join(dataset_path, "wavs"))
    )
